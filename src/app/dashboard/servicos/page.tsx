    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="relative flex-1 max-w-sm">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 h-9 rounded-lg border border-input bg-card text-sm focus:outline-none focus:ring-2 focus:ring-primary-500"
          />
        </div>
        <div className="flex gap-1 rounded-lg border border-border bg-muted p-1 h-9 overflow-x-auto">
          {(
            [
            ...
            <button
              ...
              className={cn(
                "px-3 rounded-md text-xs font-medium transition-colors whitespace-nowrap",
                          ...
                          {s.status === "andamento" && (
                            <>
                              <button
                                ...
                                className="p-1.5 rounded text-muted-foreground hover:text-success hover:bg-success-50 transition-colors"
                              ...
                              <button
                                ...
                                className="p-1.5 rounded text-muted-foreground hover:text-danger hover:bg-danger-50 transition-colors"
      ...
      <div className="md:hidden space-y-3">
        {loading ? (
          ...
          filtered.map((s) => (
            <Link key={s.id} href={`/dashboard/servicos/${s.id}`}>
              <Card className="hover:shadow-md transition-shadow">
                <CardContent className="p-4">
                  <div className="flex items-start justify-between gap-2 mb-2">
                    <div className="min-w-0 flex-1">
                      <p className="font-medium text-foreground truncate">
                        {s.cliente?.nome ?? "Sem cliente"}
                      </p>
